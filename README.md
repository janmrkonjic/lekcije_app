...
### Git Commit sporočila

Uporabljamo [Conventional Commits](https://www.conventionalcommits.org/):

```
feat: dodana funkcionalnost iskanja
fix: popravljena napaka pri brisanju
docs: posodobljen README
style: formatiranje kode
refactor: refaktorirane komponente
test: dodani unit testi
```
...
- Jan Mrkonjić - *Initial work* - [janmrkonjic](https://github.com/janmrkonjic)

## 📞 Kontakt

Za vprašanja in predloge lahko odprete issue na GitHubu ali kontaktirate avtorje.
